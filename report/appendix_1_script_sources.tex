...
\lstinputlisting[language=Bash]{../scripts/packet_pincer_results_plots.py}

\section{packet\_pincer\_results\_plots\_list.py}
\lstinputlisting[language=Bash]{../scripts/packet_pincer_results_plots_list.py}

\section{packet\_pincer\_preprocess\_results.py}
\lstinputlisting[language=Bash]{../scripts/packet_pincer_preprocess_results.py}
