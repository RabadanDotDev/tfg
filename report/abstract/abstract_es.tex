...
\begin{center}
    \setlength\fboxsep{0.05\textwidth}\fbox{
        \parbox[t][\textwidth]{0.8\textwidth}{
            ...
            \quad Se ha utilizado la herramienta desarrollada para analizar el tráfico de red de un conjunto de datos públicos y con los datos resultantes se ha entrenado un modelo utilizando el algoritmo Random Forest, obteniéndose un valor de precisión del 99.95\% y una puntuación F1 media del 98.66\%
