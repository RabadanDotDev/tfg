...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.62\linewidth]{media/packet_pincer_train_models_decision_trees.png}
    \end{center}
    \caption{Flujo de la aplicación durante su ejecución}\label{fig:decisiontreematrix}
\end{figure}
