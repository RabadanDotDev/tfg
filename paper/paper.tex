...
\begin{multicols}{2}
    ...
    % Ejecución con etiquetado (mencionar stats ejecucion + paquetes + total contenidos + desbalance)

    % Pasos preparación datos

    % Decir que modelos hemos entrenado, cual ha tenido mejores resultados
