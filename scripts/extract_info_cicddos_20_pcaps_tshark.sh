...
FOLDER_1_RESULTS_FOLDER="./tmp/03-11.pcap"
FOLDER_2="/Datasets/CICDDoS2019/pcap/01-12"
FOLDER_2_RESULTS_FOLDER="./tmp/01-12.pcap"
...
function analyze_pcap_folder {
    ...
    do
        ...
        file=$(basename "$pcap")
        file="$FOLDER_1_RESULTS_FOLDER/$file.csv"
    ...
    do
        file=$(basename "$pcap")
        file="$FOLDER_1_RESULTS_FOLDER/$file.treeproto.txt"
    ...
    do
        file=$(basename "$pcap")
        file="$FOLDER_1_RESULTS_FOLDER/$file.ipproto.csv"
